...
| `search-no-user.html` | `src/pages/js/search-no-user.ts` | `top-bar`, `search-bar`, `search-results`, `bottom-bar` | `top-bar.json`, `search-bar.json`, `outfits.json`, `bottom-bar.json` |
| `search-with-user.html` | `src/pages/js/search-with-user.ts` | `side-bar`, `search-bar`, `profile-photo`, `search-results`, `bottom-bar` | `side-bar.json`, `search-bar.json`, `profile-photo.json`, `outfits.json`, `bottom-bar.json` |
...
| `profile.html` | `src/pages/js/profile.ts` | `side-bar`, `profile-photo`, `search-results`, `bottom-bar` | `side-bar.json`, `profile.json`, `outfits.json`, `profile-photo.json`, `bottom-bar.json` |
...
| `upload.html` | `src/pages/js/upload.ts` | `side-bar`, `outfit-upload-form`, `bottom-bar` | `side-bar.json`, `outfit-upload-form.json`, `bottom-bar.json` |
